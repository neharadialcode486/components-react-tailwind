...
const TabsCard = () => {
    ...
    return (
        <div className='bg-white md:py-16 sm:py-14 py-10'>
            <div className="container my-2.5">
                <h2 className='font-normal text-5xl text-center'>Shop By <span className='font-bold'>Category</span></h2>
                ...
                <div className="overflow-x-scroll md:overflow-x-visible w-full mt-8 p-2">
                    <div className="max-w-[551px] relative z-10 w-full mx-auto flex md:justify-center items-center gap-2.5 border-medium-gray border rounded-full p-2.5">
