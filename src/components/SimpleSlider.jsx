    ...
    <section className="flex items-center min-h-screen">
      <div className="px-3 mx-auto max-w-6xl">
        ...
        <div className="relative max-w-6xl">
          ...
          <div className="flex justify-between absolute w-full left-0 top-44">
            <button className="prev w-10 h-10 rounded-full border border-[#DA6015] flex items-center justify-center group/btn transition-all duration-200 hover:bg-[#DA6015] absolute -left-16">
              <svg
                width="11"
                height="19"
                viewBox="0 0 11 19"
            ...
            <button className="last w-10 h-10 rounded-full border border-[#DA6015] flex items-center justify-center group/btn transition-all duration-200 hover:bg-[#DA6015] absolute -right-14">
              <svg
                width="11"
                height="19"
                viewBox="0 0 11 19"
